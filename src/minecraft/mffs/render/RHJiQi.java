...
public class RHJiQi implements ISimpleBlockRenderingHandler
{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
	{
		...
		{
			GL11.glPushMatrix();
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, FMLClientHandler.instance().getClient().renderEngine.getTexture(ModularForceFieldSystem.MODEL_DIRECTORY + RenderProjector.TEXTURE_NAME));
			GL11.glTranslated(0.5, 1.5, 0.5);
			GL11.glRotatef(180F, 0.0F, 0.0F, 1.0F);
			RenderProjector.MODEL.render(0, 0.0625F);
			GL11.glPopMatrix();
		}
		else
		{

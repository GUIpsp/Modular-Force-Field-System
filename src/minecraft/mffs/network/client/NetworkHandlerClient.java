        ...
        switch (typ)
        {
            ...
            case 1:
                ...
                if ((tileEntity instanceof TileEntityMFFS))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityMFFS.class, new String[]
                        {
                            fieldname
                        });
                ...
                if ((tileEntity instanceof TileEntityCapacitor))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityCapacitor.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntityExtractor))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityExtractor.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntityConverter))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityConverter.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntityProjector))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityProjector.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntityDefenseStation))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityDefenseStation.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntitySecurityStation))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntitySecurityStation.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntitySecStorage))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntitySecStorage.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);
                ...
                if ((tileEntity instanceof TileEntityControlSystem))
                {
                    try
                    {
                        Field f = ReflectionHelper.findField(TileEntityControlSystem.class, new String[]
                        {
                            fieldname
                        });
                        reflectionsetvalue(f, tileEntity, dat, fieldname);

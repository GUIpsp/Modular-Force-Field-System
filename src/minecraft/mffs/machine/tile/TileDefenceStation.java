...
public class TileDefenceStation extends TModuleAcceptor implements IDefenseStation
{
	...
	{
		return this.getModuleCount(ModularForceFieldSystem.itMJuLi) + this.getActionRange() + 3;
	}

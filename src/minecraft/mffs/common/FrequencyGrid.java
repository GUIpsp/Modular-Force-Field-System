	...
	public static class Worldlinknet {
		...
		public int refreshID(TileEntityMFFS tileEntity, int remDeviceID) {
			...
			if ((tileEntity instanceof TileEntitySecStorage)) {
				...
				this.SecStorage.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityControlSystem)) {
				...
				DeviceID = remDeviceID;
				this.ControlSystem.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntitySecurityStation)) {
				...
				DeviceID = remDeviceID;
				this.SecStation.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityDefenseStation)) {
				...
				DeviceID = remDeviceID;
				this.DefStation.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityCapacitor)) {
				...
				DeviceID = remDeviceID;
				this.Capacitors.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityConverter)) {
				...
				DeviceID = remDeviceID;
				this.Converter.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityExtractor)) {
				...
				DeviceID = remDeviceID;
				this.Extractor.put(Integer.valueOf(DeviceID),
			...
			if ((tileEntity instanceof TileEntityProjector)) {
				...
				DeviceID = remDeviceID;
				this.Projector.put(Integer.valueOf(DeviceID),
		...
		public int connectedtoCapacitor(TileEntityCapacitor Cap, int range) {
			...
			for (TileEntityProjector tileentity : this.Projector.values()) {
				if ((tileentity.getPowerSourceID() == Cap.getPowerStorageID())
						&& (range >= PointXYZ.distance(
								tileentity.getMachinePoint(),
								Cap.getMachinePoint()))) {
					counter++;
				}
		...
		public TileEntityMFFS getTileEntityMachines(String displayname, int key) {
			...
			if (tem != null) {
				switch (tem.ordinal()) {
				case 1:
					return (TileEntityMFFS) getProjector().get(
							Integer.valueOf(key));
				case 2:
					return (TileEntityMFFS) getExtractor().get(
							Integer.valueOf(key));
				case 3:
					return (TileEntityMFFS) getCapacitor().get(
							Integer.valueOf(key));
				case 4:
					return (TileEntityMFFS) getConverter().get(
							Integer.valueOf(key));
				case 5:
					return (TileEntityMFFS) getDefStation().get(
							Integer.valueOf(key));
				case 6:
					return (TileEntityMFFS) getSecStation().get(
							Integer.valueOf(key));
				case 7:
					return (TileEntityMFFS) getSecStorage().get(
							Integer.valueOf(key));
				case 8:
					return (TileEntityMFFS) getControlSystem().get(
							Integer.valueOf(key));
				}
			}

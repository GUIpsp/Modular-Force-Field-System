...
public class ItemModuleWall extends ItemModuleBase {
	...
	public void calculateField(IModularProjector projector, Set ffLocs) {
		...
		for (int x1 = 0 - projector
				.countItemsInSlot(IModularProjector.Slots.FocusLeft); x1 < projector
				.countItemsInSlot(IModularProjector.Slots.FocusRight) + 1; x1++) {
			for (int z1 = 0 - projector
					.countItemsInSlot(IModularProjector.Slots.FocusDown); z1 < projector
					.countItemsInSlot(IModularProjector.Slots.FocusUp) + 1; z1++) {
				for (int y1 = 1; y1 < projector
					...
					if (((projector.getSide() != 0) && (projector.getSide() != 1))
							|| (((tpx == 0) && (tpz != 0))
									|| ((tpz == 0) && (tpx != 0))
									|| ((tpz == 0) && (tpx == 0)) || (((projector
									.getSide() != 2) && (projector.getSide() != 3)) || (((tpx == 0) && (tpy != 0))
									|| ((tpy == 0) && (tpx != 0))
									|| ((tpy == 0) && (tpx == 0)) || (((projector
									.getSide() == 4) || (projector.getSide() == 5)) && (((tpz == 0) && (tpy != 0))

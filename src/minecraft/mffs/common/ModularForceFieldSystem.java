...
public class ModularForceFieldSystem
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        try {
            ...
            monaziteOreGeneration = new OreGenReplaceStone("Monazite Ore", "oreMonazite", new ItemStack(blockMonaziteOre), 80, MFFSProperties.monazitWorldAmount, 4).enable(MFFSConfiguration.getConfiguration());
            OreGenerator.addOre(monaziteOreGeneration);
            
        } catch (Exception e) {
            LOGGER.severe("Failed to configuration!");

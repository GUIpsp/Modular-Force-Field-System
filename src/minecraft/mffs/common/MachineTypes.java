...
public enum MachineTypes {
	...
	Projector(TileEntityProjector.class, GuiProjector.class,
			ContainerProjector.class, ModularForceFieldSystem.blockProjector,
			"KyKyFyKJK", "ByByKyBaB"), Extractor(TileEntityExtractor.class,
			GuiExtractor.class, ContainerForceEnergyExtractor.class,
			ModularForceFieldSystem.blockExtractor, " C xFx G ", " E xKx J "), Capacitor(
			TileEntityCapacitor.class, GuiCapacitor.class,
			ContainerCapacitor.class, ModularForceFieldSystem.blockCapacitor,
			"xJxCFCxJx", "xaxEKExax"), Converter(TileEntityConverter.class,
			GuiConverter.class, ContainerConverter.class,
			ModularForceFieldSystem.blockConverter, "ANAJOMAPA", "AKAaJIAMA"), DefenceStation(
			TileEntityDefenseStation.class, GuiAreaDefenseStation.class,
			ContainerAreaDefenseStation.class,
			ModularForceFieldSystem.blockDefenceStation, " J aFa E ",
			" a EKE C "), SecurityStation(TileEntitySecurityStation.class,
			GuiSecurityStation.class, ContainerSecurityStation.class,
			ModularForceFieldSystem.blockSecurityStation, "KCKCFCKJK",
			"CECEKECaC"), SecurityStorage(TileEntitySecStorage.class,
			GuiSecStorage.class, ContainerSecStorage.class,
			ModularForceFieldSystem.blockSecurityStorage, "AAAACAAAA",
			"AAAAEAAAA"), ControlSystem(TileEntityControlSystem.class,
			GuiControlSystem.class, ContainerControlSystem.class,
			ModularForceFieldSystem.blockControlSystem, "aCaAFAACA",
			"aEaAKAAEA");
	...
	private MachineTypes(Class<? extends TileEntity> tileEntity,
			Class<? extends GuiScreen> gui,
			Class<? extends Container> container, Block block, String recipeic,
			String recipeue) {
	...
	public static void initialize() {
		for (MachineTypes mach : values()) {
			...
			GameRegistry.registerTileEntity(mach.tileEntity,
					mach.block.getBlockName());

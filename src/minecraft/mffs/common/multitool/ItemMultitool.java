...
public abstract class ItemMultitool extends ItemMFFSElectric implements
		IForceEnergyItems {
	...
	@Override
	public abstract boolean onItemUseFirst(ItemStack paramItemStack,
			EntityPlayer paramEntityPlayer, World paramWorld, int paramInt1,
			int paramInt2, int paramInt3, int paramInt4, float paramFloat1,
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player,
		...
		String tooltip = String.format("%d FE/%d FE ",
				new Object[] { Integer.valueOf(getAvailablePower(itemStack)),
	...
	public int getItemDamage(ItemStack itemStack) {
		return 101 - getAvailablePower(itemStack) * 100

...
public class ItemWrench extends ItemMultitool implements IToolConfigurator,
		IToolWrench, ICrowbar {
				...
				if (((IMFFS_Wrench) tileentity).wrenchCanManipulate(player,
					...
					if ((tileentity instanceof TileEntityMFFS)) {
						...
						if ((tileentity instanceof TileEntitySecurityStation)) {
							if (((TileEntitySecurityStation) tileentity)
									.isActive()) {
								return false;
							}
						}
						if ((tileentity instanceof TileEntityDefenseStation)) {
							if (((TileEntityDefenseStation) tileentity)
									.isActive()) {
								return false;
							}
						}
					...
					world.spawnEntityInWorld(new EntityItem(world, x, y, z,
							new ItemStack(
									net.minecraft.block.Block.blocksList[world

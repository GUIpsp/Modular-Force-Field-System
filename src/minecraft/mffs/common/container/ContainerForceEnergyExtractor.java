...
public class ContainerForceEnergyExtractor extends Container {
	...
	public void updateProgressBar(int i, int j) {
		...
		case 1:
			...
			break;
		case 2:
			this.ForceEnergyExtractor
					.setForceEnergyBuffer(this.ForceEnergyExtractor
	...
	public void detectAndSendChanges() {
		...
		for (int i = 0; i < this.crafters.size(); i++) {
			...
			if (this.workdone != this.ForceEnergyExtractor.getWorkDone()) {
				icrafting.sendProgressBarUpdate(this, 0,
						this.ForceEnergyExtractor.getWorkDone());
			}

			if (this.WorkCylce != this.ForceEnergyExtractor.getWorkCycle()) {
				icrafting.sendProgressBarUpdate(this, 1,
						this.ForceEnergyExtractor.getWorkCycle());
			}

			if (this.ForceEnergybuffer != this.ForceEnergyExtractor
					.getForceEnergybuffer()) {
				icrafting
						.sendProgressBarUpdate(this, 2,
								this.ForceEnergyExtractor
										.getForceEnergybuffer() & 0xFFFF);

				icrafting
						.sendProgressBarUpdate(this, 3,
								this.ForceEnergyExtractor
										.getForceEnergybuffer() >>> 16);
			}
		...
		this.ForceEnergybuffer = this.ForceEnergyExtractor
				.getForceEnergybuffer();
	}
}
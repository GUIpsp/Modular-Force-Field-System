	...
	public ContainerAreaDefenseStation(EntityPlayer player,
		...
		for (int var3 = 0; var3 < 2; var3++) {
			for (int var4 = 0; var4 < 4; var4++) {
				addSlotToContainer(new SlotHelper(this.defstation, var4 + var3
						* 4 + 5, 176 + var4 * 18, 26 + var3 * 18));
			}
		}

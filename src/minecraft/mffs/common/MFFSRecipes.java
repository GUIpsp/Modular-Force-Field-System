...
public class MFFSRecipes
{
    ...
    public static void init()
    {
        ...
        CraftingManager.getInstance().addShapelessRecipe(new ItemStack(ModularForceFieldSystem.itemCardEmpty), new Object[]
        {
        ...
        if (MFFSProperties.MODULE_IC2)
        {
            ...
            if (MFFSProperties.uumatterEnabled)
            {
                ...
                {
                    " RR", "R  ", " R ", Character.valueOf('R'), Items.getItem("matter")
                });
            }
    ...
    public static boolean addRecipe(String Recipe, int count, int forMod, Block block, Item item)
    {
        ...
        String[] recipeSplit =
        {
            Recipe.substring(0, 3), Recipe.substring(3, 6), Recipe.substring(6, 9)
        };

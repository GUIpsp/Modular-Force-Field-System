...
public class MFFSConfiguration {
	...
	private static final Configuration CONFIGURATION = new Configuration(
			new File(Loader.instance().getConfigDir(), "UniversalElectricity/"
					+ ModularForceFieldSystem.NAME + ".cfg"));
	...
	public static void initialize() {
		...
		Property prop_graphicstyle = CONFIGURATION.get(
		...
		Property chunckloader_prop = CONFIGURATION.get(
		...
		Property DefSationNPCScannoti = CONFIGURATION.get(
		...
		Property zapperParticles = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL, "renderZapperParticles", true);
		...
		Property uumatterForciciumprop = CONFIGURATION.get(
		...
		Property adminList = CONFIGURATION.get(Configuration.CATEGORY_GENERAL,
		...
		Property influencedByOther = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL, "influencedbyothermods", true);
		influencedByOther.comment = "Should MFFS be influenced by other mods? e.g. ICBM's EMP";
		influencedbyothermods = Boolean.valueOf(influencedByOther
				.getBoolean(true));

		Property ffRemoveWaterLavaOnly = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		forcefieldremoveonlywaterandlava = Boolean
				.valueOf(ffRemoveWaterLavaOnly.getBoolean(false));

		Property feTransportCost = CONFIGURATION.get(
		...
		Property feFieldBlockCost = CONFIGURATION.get(
		...
		Property BlockCreateMod = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property ffZapperMod = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property maxFFGenPerTick = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL, "forcefieldmaxblockpeerTick",
				5000);
		...
		Property fcWorkCycle = CONFIGURATION.get(
		...
		Property fcCellWorkCycle = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL, "forceciumCellWorkCycle", 230);
		...
		Property extractorPassFEGen = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property defStationKillCost = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property defStationSearchCost = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property defStationScannCost = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL,
		...
		Property Adventuremap = CONFIGURATION.get(
		...
		Property monazitWorldAmountProp = CONFIGURATION.get(
				Configuration.CATEGORY_GENERAL, "Monazite Ore Generation", 15);

...
public class GraphicButton extends GuiButton {
	...
	public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
		if (this.drawButton) {
			GL11.glBindTexture(3553, par1Minecraft.renderEngine
					.getTexture(ModularForceFieldSystem.ITEM_TEXTURE_FILE));
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);

			if (((this.tileEntity instanceof TileEntityMFFS))
					&& (this.typ == 0)) {
				drawTexturedModalRect(
						this.xPosition,
						this.yPosition,
						80 + ((TileEntityMFFS) this.tileEntity).getSwitchModi() * 16,
			...
			if ((this.tileEntity instanceof TileEntityConverter)) {
				if (this.typ == 1) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							80 + ((TileEntityConverter) this.tileEntity)
			...
			if ((this.tileEntity instanceof TileEntityControlSystem)) {
				if (((TileEntityControlSystem) this.tileEntity)
					...
					if ((this.typ == 2)
							&& (((TileEntityControlSystem) this.tileEntity)
									.getRemoteSwitchModi() > 0)) {
						drawTexturedModalRect(
								this.xPosition,
								this.yPosition,
								80 + ((TileEntityControlSystem) this.tileEntity)
			...
			if ((this.tileEntity instanceof TileEntityDefenseStation)) {
				if (this.typ == 1) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							176 + ((TileEntityDefenseStation) this.tileEntity)
				...
				if (this.typ == 2) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							64 + ((TileEntityDefenseStation) this.tileEntity)
				...
				if (this.typ == 3) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							160 + ((TileEntityDefenseStation) this.tileEntity)
			...
			if ((this.tileEntity instanceof TileEntityCapacitor)) {
				if (this.typ == 1) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							96 + ((TileEntityCapacitor) this.tileEntity)
			...
			if ((this.tileEntity instanceof TileEntityProjector)) {
				if (this.typ == 1) {
					drawTexturedModalRect(this.xPosition, this.yPosition,
							0 + ((TileEntityProjector) this.tileEntity)
									.getAccessType() * 16, 80, this.width,
							this.height);
				}
			}
		}

...
public class GEnNiu extends GuiButton
{
	...
	public GEnNiu(int id, int x, int y, Vector2 offset, GuiMFFS mainGui, String name)
	{
	...
	public GEnNiu(int id, int x, int y, Vector2 offset, GuiMFFS mainGui)
	{
		this(id, x, y, offset, mainGui, "");
	}

	public GEnNiu(int id, int x, int y, Vector2 offset)
	{
		this(id, x, y, offset, null, "");
	}

	public GEnNiu(int id, int x, int y)
	{
